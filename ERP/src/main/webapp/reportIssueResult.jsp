...
<title>Report Issue Result</title>
<!-- Bootstrap CSS -->
<link
...
<body>
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a class="dropdown-item" href="editProfileConsumer.jsp">Edit
							Profile</a>
	...
	<div class="wrapper">
		...
		<div id="content">
			<div class="container">
				<h2>
					<i class="fas fa-check-circle"></i> Issue Result
				</h2>

				<!-- Success Alert with Report ID and Solution Message -->
				<div class="alert alert-success">
					<p>
						<strong>Report ID:</strong>
						<%=request.getAttribute("reportId")%>
					</p>
					<p>
						<strong>Solution Message:</strong>
						<%=request.getAttribute("solutionMessage")%>
					</p>
				</div>

				<!-- Back to Dashboard Button -->
				<a href="consumerDashboard.jsp" class="btn btn-primary">Back to
					Dashboard</a>
			</div>
		</div>
	</div>
